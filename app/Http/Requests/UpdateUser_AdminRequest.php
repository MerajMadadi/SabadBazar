...
class UpdateUser_AdminRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'store_address' => ['nullable', 'string', 'min:5', 'max:500'],
    ...
    public function messages(): array
    {
        return [
            ...
            'address.min' => 'آدرس باید حداقل 5 کاراکتر باشد.',
            ...
            'store_address.min' => 'آدرس فروشگاه باید حداقل 5 کاراکتر باشد.',
            'store_address.max' => 'آدرس فروشگاه باید حداکثر 500 کاراکتر باشد.',
