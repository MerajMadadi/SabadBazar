...
@section('content')
    <div class="admin-dashboard-row row">
        <!-- باکس تعداد محصولات -->
        <div class="admin-dashboard-box col-md-3 col-sm-6 col-12">
            <div class="admin-dashboard-panel panel panel-primary">
        ...
        <div class="admin-dashboard-box col-md-3 col-sm-6 col-12">
            <div class="admin-dashboard-panel panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">تعداد دسته‌بندی‌ها</h3>
                </div>
                <div class="panel-body text-center">
                    <h2><strong>{{ toPersianNumber($categoriesCount) }}</strong></h2>
                    <a href="{{ route('admin.products') }}#categories" class="btn btn-xs btn-default">مدیریت دسته‌بندی‌ها</a>
                </div>
            </div>
        </div>
        ...
        <!-- باکس تعداد کاربران -->
        <div class="admin-dashboard-box col-md-3 col-sm-6 col-12">
            <div class="admin-dashboard-panel panel panel-info">
                <div class="panel-heading">
        ...
        <!-- باکس فروش‌ها -->
        <div class="admin-dashboard-box col-md-3 col-sm-6 col-12">
            <div class="admin-dashboard-panel panel panel-warning">
                <div class="panel-heading">
                    <h3 class="panel-title">کل فروش</h3>
                </div>
                <div class="panel-body text-center">
                    <h2><strong>{{ toPersianNumber(number_format($totalSales)) }}</strong> تومان</h2>
                    <a href="{{ route('admin.orders') }}" class="btn btn-xs btn-default">مدیریت سفارشات</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="admin-dashboard-orders panel panel-default">
        <div class="panel-heading">
        ...
        <div class="panel-body">
            @if($latestOrders->count())
                <div class="admin-dashboard-table-wrapper">
                    <table class="table table-striped table-bordered admin-dashboard-table">
                        <thead>
                        <tr>
                            <th>#</th>
                            <th>کاربر</th>
