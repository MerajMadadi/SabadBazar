        ...
        <div class="panel-body">
            @if($orders->count())
                <div class="order-table-wrapper">
                    <table class="order-table table table-bordered table-striped">
                        <thead>
                        <tr>
                            <th>#</th>
                            <th>کد تراکنش</th>
                        ...
                        @foreach($orders as $order)
                            <tr>
                                <td id="id-orders">{{ toPersianNumber($order->id) }}</td>
                                ...
                                <td>
                                    <a href="{{ route('order.show', $order->id) }}" class="btn btn-primary btn-xs">مشاهده جزئیات</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
